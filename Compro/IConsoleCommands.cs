...
namespace Compro
{
    ...
    public interface IConsoleCommands : IEnumerable<IConsoleCommand>
    {
        ...
        /// </summary>
        /// <param name="commandRepr">Command representation, depending on the parser used.
        /// Default parser expects string like <code>IConsoleCommands.Execute("command(1, \"test\")")</code></param>
        /// <returns>Execution result.</returns>
        ...
        /// <summary> Finds all methods with <see cref="CommandExecutableAttribute"/> on the given instance,
        /// and registers them as commands. </summary>
        ...
        /// <returns><c>true</c> if command with the given name was already registered;
